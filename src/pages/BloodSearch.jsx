      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="text-center mb-6">
          <div className="relative inline-block">
            <div className="bg-gradient-to-r from-red-500 to-red-600 rounded-full p-3 w-12 h-12 mx-auto flex items-center justify-center shadow-lg mb-3">
        ...
        {isAllowed && (
          <div className="bg-gradient-to-r from-white to-gray-50 rounded-xl shadow-lg p-6 mb-6 border border-gray-100">
            <div className="text-center mb-4">
              <div className="bg-gradient-to-r from-red-500 to-red-600 rounded-full p-2 w-10 h-10 mx-auto flex items-center justify-center mb-2">
                <FaSearch className="text-white text-sm" />
              </div>
              <h3 className="text-lg font-bold text-gray-900 mb-1">Bộ Lọc Tìm Kiếm</h3>
              <p className="text-gray-600 text-sm">Tùy chỉnh tiêu chí tìm kiếm yêu cầu máu</p>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
              ...
              <div className="bg-white rounded-lg p-4 shadow-md border border-gray-100">
                ...
                <select
                  ...
                  className="w-full px-3 py-2 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-red-500 bg-gray-50 hover:bg-white transition-colors duration-200"
                >
              ...
              <div className="bg-white rounded-lg p-4 shadow-md border border-gray-100">
                ...
                <select
                  ...
                  className="w-full px-3 py-2 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-gray-50 hover:bg-white transition-colors duration-200"
                >
              ...
              <div className="bg-white rounded-lg p-4 shadow-md border border-gray-100">
                ...
                <button
                  ...
                  className="w-full bg-gradient-to-r from-red-500 to-red-600 hover:from-red-600 hover:to-red-700 text-white font-semibold py-2 px-4 rounded-lg transition-all duration-300 flex items-center justify-center space-x-2 shadow-lg hover:shadow-xl transform hover:scale-105"
                >
            ...
            <div className="mt-4 pt-4 border-t border-gray-200">
              <div className="flex flex-wrap items-center justify-center gap-2">
                <span className="text-xs text-gray-500">Bộ lọc hiện tại:</span>
        ...
        {loading && (
          <div className="bg-white rounded-lg shadow p-4 text-center">
            ...
            <p className="text-gray-600 mt-2 text-sm">Đang tải dữ liệu...</p>
          </div>
        )}
        ...
        {hasSearched && !loading && searchResults.length === 0 && (
          <div className="bg-white rounded-lg shadow p-4 text-center">
            ...
            <h3 className="text-base font-semibold text-gray-900 mb-1">Không có kết quả</h3>
          ...
          <>
            ...
            <div className="bg-gradient-to-r from-green-50 to-blue-50 rounded-lg shadow-lg p-4 mb-4 border border-green-200">
              <div className="flex items-center justify-between">
                ...
                <div className="text-right">
                  ...
                  <div className="text-xl font-bold text-green-600">{filters.maxDistance}km</div>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
              {searchResults.map((result) => (
                <div key={result.emergencyId || result.id} className="bg-white rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100 overflow-hidden">
                  {/* Header */}
                  <div className="bg-gradient-to-r from-red-500 to-red-600 p-3 text-white">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center space-x-2">
                        ...
                        <div>
                          <h4 className="text-sm font-bold">Yêu cầu #{result.emergencyId || result.id}</h4>
                          <p className="text-red-100 text-xs">Cần máu khẩn cấp</p>
                        </div>
                      </div>
                      <div className="text-right">
                        <div className="text-lg font-bold">{result.bloodType}</div>
                  ...
                  <div className="p-4">
                    ...
                    <div className="flex items-center justify-between mb-3">
                      <div className="flex items-center space-x-2">
                        ...
                        <div>
                          ...
                          <div className="text-lg font-bold text-red-600">{result.requiredUnits} ml</div>
                        </div>
                      </div>
                      <div className="text-right">
                        <div className="text-xs text-gray-500">Khoảng cách</div>
                        <div className="text-sm font-semibold text-gray-900">{result.distanceText}</div>
                    ...
                    <div className="bg-blue-50 rounded-lg p-3 mb-3">
                      <div className="flex items-start space-x-2">
                        ...
                        <div className="flex-1">
                          <h5 className="font-semibold text-gray-900 text-sm mb-1">{result.hospitalName}</h5>
                          <p className="text-xs text-gray-600 mb-1">{result.hospitalAddress}</p>
                    ...
                    <div className="bg-gray-50 rounded-lg p-3 mb-3">
                      <div className="flex items-start space-x-2">
                        ...
                        <div className="flex-1">
                          <h5 className="font-semibold text-gray-900 text-sm mb-1">Thông tin người yêu cầu</h5>
                    ...
                    {result.emergencyNote && (
                      <div className="bg-yellow-50 border-l-4 border-yellow-400 p-3 rounded-r-lg">
                        <div className="flex items-start space-x-2">
                          <FaInfoCircle className="text-yellow-600 mt-0.5 text-sm" />
                          <div>
                            <h6 className="font-semibold text-yellow-800 text-xs mb-1">Ghi chú</h6>
                            <p className="text-xs text-yellow-700">{result.emergencyNote}</p>
                          </div>
                        </div>
                      </div>
                    )}
